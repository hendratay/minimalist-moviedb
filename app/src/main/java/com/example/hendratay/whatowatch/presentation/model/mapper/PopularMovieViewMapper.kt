...
class PopularMovieViewMapper @Inject constructor(private val movieResultsViewMapper: MovieResultsViewMapper): Mapper<PopularMovieView, PopularMovie> {

    override fun mapToView(type: PopularMovie): PopularMovieView {
        return PopularMovieView(type.page, movieResultsViewMapper.mapToView(type.results), type.totalResults, type.totalPages)
    }
